...
namespace AppTools.dao
{
    ...
    class SqliteHelper
    {
        public static SQLiteConnection cn = null;
        ...
        public static SQLiteConnection getConnection()
        {
            ...
            //string dbfile = AppDomain.CurrentDomain.BaseDirectory + "AppTools.sqlite";
            string dbfile = System.Windows.Forms.Application.StartupPath + "\\AppTools.sqlite";
            //System.Windows.Forms.MessageBox.Show(dbfile);
            if (!File.Exists(dbfile))
            {
                System.Windows.Forms.MessageBox.Show("没有数据库文件");
                SQLiteConnection.CreateFile("AppTools.sqlite");
            }
            if (cn == null)
            {
                //cn = new SQLiteConnection("Data Source=AppTools.sqlite;Version=3;");
                cn = new SQLiteConnection("Data Source=" + dbfile + ";Version=3;");
                cn.Open();
        ...
        {
            return CreateCommand(getConnection(), commandText, commandParameters);
        }
